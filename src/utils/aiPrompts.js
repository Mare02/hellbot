...
const chatReplyPrompt = (conversation) => {
    return `You are a helpful Discord bot. The recent conversation history is:\n${conversation}\n\nReply naturally to the user who mentioned you or replied to you. Keep the response concise, relevant, and conversational.`;
}
